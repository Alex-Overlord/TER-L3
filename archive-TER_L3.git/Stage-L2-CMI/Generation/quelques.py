...
while i < 2 :
    ...
    sujetM=['vigil', 'policier', 'pompier', 'hibou', 'pou', 'bijou', 'corail', 'chacal', 'enseignant']
...
#gestion des accords avec le "l'"
    ...
    quantificateursM = ['certains','quelques']
    quantificateursF = ['certaines', 'quelques']
...
#gestion de quelques verbes du 3ème groupe   
    ...
    if (choix1 == 'certains' or choix1 =='certaines') :
    ...
    print(complementPhrase+' test 1')
    finPhrase = 'peut se lire'
    finPhrase2 = 'signifie que'
    chance = random.randrange(1,3,1)
    chance2 = random.randrange(1,3,1)
    fichier= open('quelques.txt','w')
    if chance == 1:
        if chance2 ==1 :
            if choixArticle == "l'" :    
                n1 = '\n'
                phrases = ['La phrase :','     '+choixArticle+choixSujet+' '+choixVerbe+' '+'des'+' '+complementPhrasePluriel+' '+finPhrase, n1,
                           choixArticle+choixSujet+' '+choixVerbe+' '+choix1+' '+complementPhrasePluriel, n1,
                           choixArticle+choixSujet+' '+choixVerbe+' '+choix2+' '+complementPhrasePluriel, n1,
                           choixArticle+choixSujet+' '+choixVerbe+' '+choix3+' '+complementPhrasePluriel]
                fichier.writelines(phrases)
                print('La phrase :','     '+choixArticle+choixSujet, choixVerbe, 'des', complementPhrasePluriel, finPhrase)
                print(choixArticle+choixSujet, choixVerbe, choix1 , complementPhrasePluriel)
                print(choixArticle+choixSujet, choixVerbe, choix2 , complementPhrasePluriel)
            ...
            if choixArticle == "l'" :
                n1 = '\n'
                phrases = ['La phrase :','     '+choixArticle+choixSujet+' '+choixVerbe+' '+'des'+' '+complementPhrasePluriel+' '+finPhrase2, n1,
                           choixArticle+choixSujet+' '+choixVerbe+' '+choix1+' '+complementPhrasePluriel, n1,
                           choixArticle+choixSujet+' '+choixVerbe+' '+choix2+' '+complementPhrasePluriel, n1,
                           choixArticle+choixSujet+' '+choixVerbe+' '+choix3+' '+complementPhrasePluriel]
                fichier.writelines(phrases)
                print('La phrase :','     '+choixArticle+choixSujet, choixVerbe, 'des', complementPhrasePluriel, finPhrase2)
                print(choixArticle+choixSujet, choixVerbe, choix1 , complementPhrasePluriel)
                print(choixArticle+choixSujet, choixVerbe, choix2 , complementPhrasePluriel)
                print(choixArticle+choixSujet, choixVerbe+' '+choix3+' '+complementPhrasePluriel)
        ...
        if chance2 == 1 :
            if choixArticle == "l'" :
                 ...
                 phrases = ['La phrase :'+" Il y'a "+choixArticle+choixSujet+' qui '+choixVerbe+' les'+' '+complementPhrasePluriel+' '+finPhrase, n1,
                            ...
                            choixArticle+choixSujet+' '+choixVerbe+' '+choix3+' '+complementPhrasePluriel]
                 fichier.writelines(phrases)
                 print('La phrase :',"Il y'a "+choixArticle, choixSujet,'qui', choixVerbe, 'des', complementPhrasePluriel, finPhrase)
                 print(choixArticle+choixSujet, choixVerbe, choix1, complementPhrasePluriel)
                 print(choixArticle+choixSujet, choixVerbe, choix2, complementPhrasePluriel)
                 print(choixArticle+choixSujet, choixVerbe+' '+choix3+' '+complementPhrasePluriel)
            else :
